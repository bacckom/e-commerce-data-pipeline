...
from ecommerce.data_schema.order_payments import OrderPaymentsObject
...
class OrderPaymentsLoader(BaseLoader):
    def __init__(
        ...
        self._spark = spark
        self._table_name = configs.source_tables.order_payments.table_name
        self._path = configs.root_path.joinpath(configs.source_tables.order_payments.path)
